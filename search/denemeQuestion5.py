...
class CornersProblem(search.SearchProblem):
    ...
    def getStartState(self):
        ...
        """
        "*** YOUR CODE HERE ***"
        return StateSpace(self.startingPosition, self.corners)
    ...
    def isGoalState(self, state):
        ...
        """
        "*** YOUR CODE HERE ***"
        #isGoal=self.allCorners[0] and self.allCorners[1] and self.allCorners[2] and self.allCorners[3]
    ...
    def getSuccessors(self, state):
        ...
        for action in [Directions.NORTH, Directions.SOUTH, Directions.EAST, Directions.WEST]:
            ...
            if not self.walls[nextx][nexty]:                
                ...
                nextState =StateSpace((nextx,nexty), state.corners)
                print "Next pos is", (nextx,nexty)
